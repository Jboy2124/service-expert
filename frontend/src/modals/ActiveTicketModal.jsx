...
const ActiveTicketModal = () => {
  return (
    <div>
        <div class="modal fade" id="activeUAMTicketModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="activeUAMTicketModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="activeUAMTicketModal">Ticket Details</h5>
        ...
        <div class="modal fade" id="activeSRTicketModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="activeSRTicketModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="activeSRTicketModal">Ticket Details</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form > 
                                ...
                                <div class="row mb-1">
                                    <label for="" class="col-sm-3 form-label">Acticity Details</label>
                                    <div class="col-sm-9">
                                          <input type="text" class="form-control" id="" disabled/>
                                    </div>
                                </div>
