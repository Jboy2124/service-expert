...
const UAMForm = (props) => {
    ...
    const handleAddUAMticket = (event) => {
        ...
        let arrayEmail = ["ecsantos1990@gmail.com" , "jufelabecia@gmail.com", "danharry2014@gmail.com"];
        ...
        emailjs.sendForm('serviceXpert', 'template_i0zwmvm', formUAM.current, 'NPopNT28eeac99Wq0')
      .then((result) => {
        ...
        axios.post("/api/insertsr", {
            ...
            emailjs.sendForm('serviceXpert', 'template_i0zwmvm', formSR.current, 'NPopNT28eeac99Wq0')
            .then((result) => {
                console.log(result.text);
            }, (error) => {
                console.log(error.text);
    ...
    <div >  
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form ref={formSR} onSubmit={handleAddSRTicket} method='post'> 
                            <div className="row mb-1">
